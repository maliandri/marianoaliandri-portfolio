...
export default function LinkedInSidebar() {
  ...
  // ═══════════════════════════════════════════
  // COLLAPSED — pestaña vertical (solo desktop)
  // ═══════════════════════════════════════════
  if (!isExpanded) {
    return (
      <motion.button
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed top-[90px] right-2 w-[220px] z-40 hidden xl:flex flex-col gap-1.5"
      ...
      {/* ═══════════════════════════════════════════ */}
      {/* MOBILE — banner horizontal inline           */}
      {/* ═══════════════════════════════════════════ */}
      <div
        className="xl:hidden w-full mt-8 mb-4"
