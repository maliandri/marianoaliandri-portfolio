  ...
  >
    {isOpen ? (
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed bottom-36 right-6 z-40 w-96 h-[500px] max-h-[calc(100vh-10rem)] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden"
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 flex items-center gap-3">
              ...
              <div className="flex gap-2">
                ...
                <motion.button
                  onClick={closeChat}
                  className="p-2 bg-white bg-opacity-20 rounded-lg hover:bg-red-500 hover:bg-opacity-100 transition-all duration-200"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  title="Cerrar chat"
                >
