...
// === ÚNICO CAMBIO: link de pago para mostrar al final ===
const PAGO_LINK = 'https://link.mercadopago.com.ar/marianoaliandri';
...
¿Podemos agendar una reunión?`;
                        ...
                        {/* === ÚNICO AGREGADO: Link de pago al final === */}
                        <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                          <div className="font-semibold text-blue-900 dark:text-blue-100">Pagar ahora (link de pago)</div>
                          <p className="mt-1 text-sm text-blue-900/80 dark:text-blue-200/80">
                            Al hacer clic se abre el enlace de cobro en una nueva pestaña.
                          </p>
                          <div className="mt-3">
                            <a
                              href={PAGO_LINK}
                              ...
                              className="inline-block px-5 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white"
                            >
                              Ir a pagar
                            </a>
                            <div className="mt-2 text-sm text-blue-900/80 dark:text-blue-200/80 break-all">
                              {PAGO_LINK}
                            </div>
                          </div>
                        </div>
