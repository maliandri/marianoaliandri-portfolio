...
export default function Footer() {
  ...
  const certifications = [
    { name: 'Mercado Pago Certified', logo: '💳' },
    { name: 'React Developer', logo: '⚛️' },
    { name: 'TypeScript Expert', logo: '🔷' },
  ];
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-8 mb-8">
          <div className="flex flex-wrap justify-center items-center gap-6">
            {certifications.map((cert) => (
              <div
                key={cert.name}
                className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-700 rounded-lg shadow-sm hover:shadow-md transition-shadow"
                title={cert.name}
              >
