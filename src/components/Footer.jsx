...
export default function Footer() {
  ...
  const technologies = [
    ...
    },
    {
      name: 'Mercado Pago',
      icon: (
        <svg className="w-10 h-10" viewBox="0 0 80 80" fill="currentColor">
          <path d="M40 0C17.91 0 0 17.91 0 40s17.91 40 40 40 40-17.91 40-40S62.09 0 40 0zm17.5 52.5l-7.5-17-7.5 17h-5l10-22h5l10 22h-5zm-25 0h-5V30.5h5v22zm30 0h-5V30.5h5v22z"/>
        </svg>
      ),
      color: 'text-[#009EE3]'
    },
  ...
  const certifications = [
    {
      ...
      logo: (
        <svg className="w-8 h-8" viewBox="0 0 80 80" fill="currentColor">
          <path d="M40 0C17.91 0 0 17.91 0 40s17.91 40 40 40 40-17.91 40-40S62.09 0 40 0zm17.5 52.5l-7.5-17-7.5 17h-5l10-22h5l10 22h-5zm-25 0h-5V30.5h5v22zm30 0h-5V30.5h5v22z"/>
        </svg>
      ),
      color: 'text-[#009EE3]'
