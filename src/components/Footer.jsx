...
export default function Footer() {
  ...
  const technologies = [
    ...
    },
    {
      name: 'Netlify',
      icon: (
        <svg className="w-10 h-10" viewBox="0 0 128 128" fill="currentColor">
          <g>
            <path d="M61.1 14.5L47.4 28.2l13.7 13.7 13.7-13.7z"/>
            <path d="M74.8 28.2L61.1 41.9l13.7 13.7 13.7-13.7z"/>
            <path d="M47.4 28.2L33.7 41.9l13.7 13.7 13.7-13.7z"/>
            <path d="M61.1 41.9L47.4 55.6l13.7 13.7 13.7-13.7z"/>
            <path d="M88.5 41.9L74.8 55.6l13.7 13.7 13.7-13.7z"/>
            <path d="M33.7 41.9L20 55.6l13.7 13.7 13.7-13.7z"/>
            <path d="M61.1 69.3L47.4 83l13.7 13.7 13.7-13.7z"/>
            <path d="M74.8 83L61.1 96.7l13.7 13.7 13.7-13.7z"/>
            <path d="M47.4 83L33.7 96.7l13.7 13.7 13.7-13.7z"/>
          </g>
        </svg>
      ),
      color: 'text-[#00C7B7]'
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            {technologies.map((tech) => (
              <div
                ...
                title={tech.name}
              >
                <div className={`${tech.color} transform group-hover:scale-110 transition-transform duration-300`}>
                  {tech.icon}
                </div>
                <span className="text-xs text-gray-600 dark:text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity">
                  {tech.name}
                </span>
              </div>
            ))}
